        ...
        if (strcmp(type->valuestring, "tts") == 0) {
            ...
            if (strcmp(state->valuestring, "start") == 0) {
                ...
                if (cJSON_IsString(text)) {
					...
					uart_write_bytes(UART_NUM_1, text->valuestring, strlen(text->valuestring));
...
void Application::HandleStateChangedEvent() {
    ...
    switch (new_state) {
        ...
        case kDeviceStateIdle:
            ...
            audio_service_.EnableWakeWordDetection(true);
			// Send STATE
			uart_write_bytes(UART_NUM_1, "[STATE] STANDBY\n", 17);
			// ------------------------------------------------
            break;
        case kDeviceStateConnecting:
            ...
            display->SetChatMessage("system", "");
			// Send STATE
			uart_write_bytes(UART_NUM_1, "[STATE] CONNECTING\n", 17);
			// ------------------------------------------------
            break;
        case kDeviceStateListening:
            ...
            display->SetEmotion("neutral");
			// Send STATE
			uart_write_bytes(UART_NUM_1, "[STATE] LISTENING\n", 17);
			// ------------------------------------------------
        ...
        case kDeviceStateSpeaking:
			...
			// Send STATE
			uart_write_bytes(UART_NUM_1, "[STATE] SPEAKING\n", 17);
			// ------------------------------------------------
